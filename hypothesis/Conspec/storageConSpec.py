...
class RolloutStorage(object):
    ...
    def store_prototypes_used(self, prototypesUsed,count_prototypes_timesteps_criterion):  
        # this arises ONLY from the need to add the WHOLE SET, it is evoked ONCE, happens at the end of ConSpec.update_conspec.
