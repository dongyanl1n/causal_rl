...
class RolloutStorage(object):
    def __init__(self, num_steps, num_processes, obs_shape, 
        ...
        self.rewards = torch.zeros(num_steps, num_processes, 1)  # might get updated to include intrinsic reward
        self.rewardsORIG = torch.zeros(num_steps, num_processes, 1)  # will only be extrinsic reward
